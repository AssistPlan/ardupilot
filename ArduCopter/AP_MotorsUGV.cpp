...
const AP_Param::GroupInfo AP_MotorsUGV::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("SAFE_DISAM", 3, AP_MotorsUGV, _disarm_disable_pwm, 0),
    ...
    // @Range: 0 100
    // @User: Advanced
    AP_GROUPINFO("VEC_THR_BA", 10, AP_MotorsUGV, _vector_throttle_base, 0.0f),
    ...
    // @Range: 0 10
    // @User: Advanced
    AP_GROUPINFO("SPD_SCA_BA", 11, AP_MotorsUGV, _speed_scale_base, 1.0f),
...
void AP_MotorsUGV::init_copter()
{
    // setup servo ouput
    setup_servo_output_copter();

    // setup pwm type
    //setup_pwm_type_copter();

    // set safety output
    // delete safety setup.
    //setup_safety_output_copter();
...
void AP_MotorsUGV::setup_safety_output_copter()
{
    if (_pwm_type == PWM_TYPE_BRUSHED_WITH_RELAY) {
        ...
        SRV_Channels::set_trim_to_min_for(SRV_Channel::k_motor3);
        SRV_Channels::set_trim_to_min_for(SRV_Channel::k_motor4);
        SRV_Channels::set_trim_to_min_for(SRV_Channel::k_motor5);
    }
    ...
    if (_disarm_disable_pwm) {
        ...
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor3, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor5, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);
    } else {
        ...
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor3, SRV_Channel::SRV_CHANNEL_LIMIT_TRIM);
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_TRIM);
        SRV_Channels::set_safety_limit(SRV_Channel::k_motor5, SRV_Channel::SRV_CHANNEL_LIMIT_TRIM);
    }
    ...
    SRV_Channels::set_failsafe_limit(SRV_Channel::k_motor3, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);
    SRV_Channels::set_failsafe_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);
    SRV_Channels::set_failsafe_limit(SRV_Channel::k_motor5, SRV_Channel::SRV_CHANNEL_LIMIT_ZERO_PWM);

}

// setup servo output ranges
void AP_MotorsUGV::setup_servo_output_copter()
{
    // k_steering are limited to -45;45 degree
    //SRV_Channels::set_angle(SRV_Channel::k_steering, SERVO_MAX);
    SRV_Channels::set_angle(SRV_Channel::k_motor3, SERVO_MAX);

    // k_throttle are in power percent so -100 ... 100
    //SRV_Channels::set_angle(SRV_Channel::k_throttle, 100);
    SRV_Channels::set_angle(SRV_Channel::k_motor4, SERVO_MAX);

    SRV_Channels::set_angle(SRV_Channel::k_motor5, SERVO_MAX);
...
void AP_MotorsUGV::init()
{
    ...
    _steering = 0.0f;
    _throttle = -100.0f;
    _throttle_prev = -100.0f;

printf("AP_MotorsUGV::init  \n");


}

// stop properas 
void AP_MotorsUGV::stop_properas()
{


    SRV_Channels::set_output_limit(SRV_Channel::k_motor1, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
    SRV_Channels::set_output_limit(SRV_Channel::k_motor2, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
    SRV_Channels::set_output_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
...
void AP_MotorsUGV::stop_motors()
{
//printf("AP_MotorsUGV::stop_motors \n");

    // set servo min value for stop motors. 
    SRV_Channels::set_output_limit(SRV_Channel::k_motor1, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
    SRV_Channels::set_output_limit(SRV_Channel::k_motor2, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
    SRV_Channels::set_output_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
    ...
    //SRV_Channels::set_output_pwm(SRV_Channel::k_motor5, 2000);
    //SRV_Channels::set_output_pwm(SRV_Channel::k_motor7, 1500);
...
//void AP_MotorsUGV::output_motor1_2_to_stop()
//{
//    SRV_Channels::set_output_scaled(SRV_Channel::k_motor1, -4500.0);
//    SRV_Channels::set_output_scaled(SRV_Channel::k_motor2, -4500.0);
//
//}
...
//printf("output_regular armed =%d\n", armed);
    if (armed) {
        ...
        //output_throttle(SRV_Channel::k_motor4, throttle*45.0);
...
//printf("throttle=%f\n", throttle);
        ...
        if (_disarm_disable_pwm) {
            ...
            // set motor to min value on disarm.
            SRV_Channels::set_output_limit(SRV_Channel::k_motor4, SRV_Channel::SRV_CHANNEL_LIMIT_MIN);
        } else {
    ...
    SRV_Channels::set_output_scaled(SRV_Channel::k_motor3, steering);
//printf("SSRV_Channel::k_motor3, steering=%f\n",steering);
